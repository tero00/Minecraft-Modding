...
public class LightSwordBase extends ItemSword implements IHasModel{

	public LightSwordBase(String name, ToolMaterial material) {
		super(material);
	...
	public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
		...
		if (slot == EntityEquipmentSlot.MAINHAND) {
			replaceModifier(modifiers, SharedMonsterAttributes.ATTACK_SPEED, ATTACK_SPEED_MODIFIER, 0.835);
		}
		return modifiers;
	}
